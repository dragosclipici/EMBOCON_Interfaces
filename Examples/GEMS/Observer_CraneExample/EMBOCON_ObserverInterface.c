...
{
	return 0; /*always fail, there are no parameters to set */
}
...
{
	return 0; /*always fail, no uncertainty is taken into account*/
}
...
{
	return 0; /*there are no parameters to be set*/
}
