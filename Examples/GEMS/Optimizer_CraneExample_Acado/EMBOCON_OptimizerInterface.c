...
#include "./crane_nmpc_export/acado.h"
...
emb_optimizer createOptimizer(emb_model model)
{
	...
	xref[0] = 1; //.x_C   = 1;     %cart position (m)
	xref[1] = 0; //.x_L   = 1.5;   %cable length (m)
	xref[2] = 1.5; //.v_C   = 0;     %cart velocity (m/s)
	xref[3] = 0; //.v_L   = 0;     %cable velocity (m/s)
	xref[4] = 0; //.theta = 0;     %cable deflection (rad)
	xref[5] = 0; //.omega = 0;     %cable deflection rate (rad/s)
	xref[6] = 0; //.u_C   = 0;     %cart controller voltage (V)
	xref[7] = 0; //.u_L   = 0;     %cable controller voltage (V)
...
int setOptParameter(emb_optimizer optim, emb_opt_context opt_context, const double optp[])
{
	...
	xref[0] = 1; //.x_C   = 1;     %cart position (m)
	xref[1] = 1.5; //.x_L   = 1.5;   %cable length (m)
	xref[2] = 0; //.v_C   = 0;     %cart velocity (m/s)
	xref[3] = 0; //.v_L   = 0;     %cable velocity (m/s)
	xref[4] = 0; //.theta = 0;     %cable deflection (rad)
	xref[5] = 0; //.omega = 0;     %cable deflection rate (rad/s)
	xref[6] = 0; //.u_C   = 0;     %cart controller voltage (V)
