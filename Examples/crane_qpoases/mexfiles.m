...
CGRecipe = 'mex -g -I. -I../../../supervisor/Interfaces/ -I''CGRoot'' -I''CGRoot/qpoases/INCLUDE'' -I''CGRoot/qpoases/SRC''  -D__MATLAB__ CGSources GemsInterfaceSources -output %s.%s';
