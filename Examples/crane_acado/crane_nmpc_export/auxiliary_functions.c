...
int run01,run02;
for( run01=0; run01<8; ++run01 ){
  for( run02=0; run02<13; ++run02 )
    printf( "%e \t", acadoVariables.x[run01*13+run02] );
  printf( "\n" );
}
}
...
for( run01=0; run01<2; ++run01 ){
  for( run02=0; run02<12; ++run02 )
    printf( "%e \t", acadoVariables.u[run01*12+run02] );
  printf( "\n" );
}
}
